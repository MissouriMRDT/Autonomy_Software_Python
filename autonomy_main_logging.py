...
from algorithms.zedTest import ObjectTracker
...
#rovecomm_node.write(RoveCommPacket(14003, 'B', (1, 1), ip_octet_4="131"))
def enable_autonomy(packet_contents):
    print(state_switcher.state)
    # rovecomm_node.write(RoveCommPacket(14003, 'B', (0, 0), ip_octet_4="131"))
    if waypoints:
        ...
        print("No waypoints")
        Logger.write_line(time.strftime("%H%M%S") + " Enable: No waypoints, staying Idle")
...
#gps_data.goal = constants.Coordinate(37.9589183,-91.7775716)
