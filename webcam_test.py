...
def main() :
    ...
    camera2 = pyfakewebcam.FakeWebcam('/dev/video3', 640, 480)
    ...
    # q1 = mp.Queue()
    # q2 = mp.Queue()
    # t1 = mp.Process(target=stream_loop, args=(q1,2,))
    # t2 = mp.Process(target=stream_loop, args=(q2,3,))
    # t1.daemon = True
    # t2.daemon = True
    # t1.start()
    # t2.start()
